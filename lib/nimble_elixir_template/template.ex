defmodule Nimble.Elixir.Template.Template do
  alias Nimble.Elixir.Template.Api.Template, as: ApiTemplate
  alias Nimble.Elixir.Template.Live.Template, as: LiveTemplate
